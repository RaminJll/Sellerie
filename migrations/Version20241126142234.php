 ...
 */
final class Version20241126142234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE emplacements (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, categorie_rayon VARCHAR(255) NOT NULL, sous_categorie VARCHAR(255) NOT NULL, type_produit VARCHAR(255) NOT NULL, etagere INT NOT NULL, INDEX IDX_4F105747F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE emplacements ADD CONSTRAINT FK_4F105747F347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
    }
